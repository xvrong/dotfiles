...
local function connect_screen()
    ...
    if #outputs == 2 then
        table.insert(cmds, "xrandr --dpi 96 --output HDMI-0 --mode 1920x1080 --rate 60 --pos 0x0 --primary --output eDP-1-1 --mode 1920x1080 --rate 120 --pos 1920x0")
    else 
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "p",     function() xrandr.xrandr()         end,
              {description = "manage multiple screen", group = "awesome"}),
